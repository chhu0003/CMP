...
//		echo $courseGradeID;
		...
		public function deleteStudent($student_number)
	{
		...
		$delete_sql_course = "DELETE FROM STUDENT_COURSES WHERE STUDENTS_STUDENT_NUMBER = $student_number";
		$delete_sql_grade = "DELETE FROM STUDENT_GRADES WHERE STUDENTS_STUDENT_NUMBER = $student_number";
	
		//query the database
		$database->query( $delete_sql_course );
		$database->query( $delete_sql_grade );
